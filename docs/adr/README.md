...
Short, dated notes on decisions that were expensive to reverse — the context, the
choice, and the consequences. Newest decisions supersede older ones explicitly.
...
| [0004](./0004-sqlite-better-sqlite3.md) | SQLite via better-sqlite3 | Accepted |
